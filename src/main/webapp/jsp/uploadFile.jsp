...
<head>
    ...
    <style type="text/css">
          *{margin: 0;padding: 0;}
          ...
          .div_center {margin : 0 auto;width:300px;text-align: center;}
...
<body>
  <div class="entire">
      ...
      <div id="buttons" class="div_center">
          <button type="button" class="btn btn-sm btn-info" id="uploadFile" name="uploadFile" >上&nbsp;&nbsp;传</button>
          <button type="button" class="btn btn-sm btn-info" id="uploadCancel" name="uploadCancel" >取&nbsp;&nbsp;消</button>
      </div>
  </div>
</body>
