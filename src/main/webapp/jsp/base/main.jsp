...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="graphs">
                    ...
                    <div class="activity_box">
                        <div class="scrollbar" id="style-2">
                            <div class="activity-row">
                                ...
                                <div class="col-xs-3 activity-img"><img src='/img/5.png' class="img-responsive" alt=""/>
                                </div>
                            ...
                            <div class="activity-row">
                                ...
                                <div class="col-xs-3 activity-img"><img src='/img/3.png' class="img-responsive" alt=""/>
                                </div>
                                <div class="col-xs-8 activity-desc">
                            ...
                            <div class="activity-row">
                                ...
                                <div class="col-xs-3 activity-img"><img src='/img/1.png' class="img-responsive" alt=""/>
                                </div>
                                <div class="col-xs-8 activity-desc">
                            ...
                            <div class="activity-row1">
                                ...
                                <div class="col-xs-3 activity-img"><img src='/img/4.png' class="img-responsive" alt=""/>
                                </div>
                                <div class="col-xs-8 activity-desc">
            ...
            <div class="copy">
                <p>Copyright &copy; 2015.Company name All rights reserved.More Templates <a href="http://www.lx.com/"
                                                                                            target="_blank"
                                                                                            title="web2">web2</a> -
                    Collect from <a href="http://www.lx.com/" title="网页模板" target="_blank">网页模板</a></p>
            </div>
        </div>
    </div>
    <%-- /#page-wrapper --%>
