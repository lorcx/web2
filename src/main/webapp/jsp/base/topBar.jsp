    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li id="autoPerson"><a href="#">审议会自动选人</a></li>
                        <li id="autoDate"><a href="#">自动设置时间为下周二</a></li>
                    </ul>
                </li>
                <%--学习+练习--%>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li id="zTree"><a href="#">zTree</a></li>
                        <li id="ifremFlush"><a href="#">ifrem刷新</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown"><a id="topBarLoginInfo" href="#">欢迎你：<s:property value="#session.nickName" /> </a></li>
                <li class="dropdown"><a id="currentDate" href="#"></a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li id="headPicUpload"><a href="#">头像上传</a></li>
